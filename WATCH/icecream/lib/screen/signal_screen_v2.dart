...
class SignalScreenV2 extends StatefulWidget {
  const SignalScreenV2({super.key});

  @override
  State<SignalScreenV2> createState() => _SignalScreenV2State();
}

class _SignalScreenV2State extends State<SignalScreenV2> {
  @override
              ...
              child: ClipRRect(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color(0xFFFDD62C).withOpacity(0.2),
                  ),
                ),
              ),
            ),
            Positioned(
              ...
              child: ClipRRect(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: Color(0xFFFDD62C)),
                ),
              ),
            ),
            Positioned(
              ...
              child: Column(
                children: [
                  ...
                  Text('빠른 차량이 있습니다', style: TextStyle(color: Colors.white, fontFamily: 'WAGURI', fontSize: 16.0 ),),
                ],
              ),
            ),
